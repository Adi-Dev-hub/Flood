...
smoothed_flood_risk_zones = gaussian_filter(flood_risk_zones, sigma=1)
...
# Define a colormap for flood risk zones (e.g., low risk=green, moderate risk=yellow, high risk=red)
risk_cmap = plt.get_cmap('inferno_r')

# Display smoothed flood risk zones while handling NaNs
# Using vmin and vmax to control color mapping
img2 = ax2.imshow(smoothed_flood_risk_zones, cmap=risk_cmap, interpolation='bilinear', vmin=1, vmax=3)
